...
contract SafeMath {
  ...
  function require(bool assertion) internal {
    if (!assertion) revert();
  }
}
...
contract coinEstate is SafeMath {
  ...
  function coinEstate(address admin_, address feeAccount_, address accountLevelsAddr_, uint feeMake_, uint feeTake_, uint feeRebate_) {
    admin = admin_;
